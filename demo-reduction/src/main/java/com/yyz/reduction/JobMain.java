...
import com.yyz.wordcount.WordCountMapper;
import com.yyz.wordcount.WordCountReduer;
...
public class JobMain {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.addInputPath(job, new Path("demo-reduction/input/wordcount.txt"));
        Path path = new Path("demo-reduction/output");
